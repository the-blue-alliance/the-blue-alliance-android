...
public class MatchSimple {
  ...
  public MatchSimple key(@javax.annotation.Nonnull String key) {
  ...
  public MatchSimple compLevel(@javax.annotation.Nonnull CompLevelEnum compLevel) {
  ...
  public MatchSimple setNumber(@javax.annotation.Nonnull Integer setNumber) {
  ...
  public MatchSimple matchNumber(@javax.annotation.Nonnull Integer matchNumber) {
  ...
  public MatchSimple alliances(@javax.annotation.Nonnull MatchSimpleAlliances alliances) {
  ...
  public MatchSimple winningAlliance(@javax.annotation.Nonnull WinningAllianceEnum winningAlliance) {
  ...
  public MatchSimple eventKey(@javax.annotation.Nonnull String eventKey) {
  ...
  public MatchSimple time(@javax.annotation.Nullable Long time) {
  ...
  public MatchSimple predictedTime(@javax.annotation.Nullable Long predictedTime) {
  ...
  public MatchSimple actualTime(@javax.annotation.Nullable Long actualTime) {
