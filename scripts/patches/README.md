...
## Details
 ...
 - `swagger-api-names.patch` is a patch that renames the retrofit interfaces generated by swagger from `DefaultApi` to `TbaApiV2`. I'm not sure how to rename the generated files via an option, so this is the next best thing
